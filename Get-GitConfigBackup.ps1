# Script to add to PowerShell profile that backs up git repositories into Cloud backup folders (like OneDrive or Google Drive)

git config --global user.name "Matt Marchese"
git config --global user.email matthew.marchese1@gmail.com

$backupObjects = [PSCustomObject] @{
    MineCraftPE = @{
        Name = "MC-PE"
        OriginalLocation = "C:\Users\username\AppData\Local\Packages\Microsoft.MinecraftUWP_8wekyb3d8bbwe\LocalState\games\com.mojang\minecraftWorlds"
